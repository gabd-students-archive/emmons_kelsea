...
```{r}
ggplot(data = msleep) +
  geom_boxplot(mapping = aes(x = conservation, y = awake, color = conservation)) +
  geom_point(mapping = aes(x = vore, y = sleep_rem, color = conservation)) +
  geom_jitter(mapping = aes(x = vore, y = sleep_rem, color = conservation)) +
  xlab("Conservation") +
  ylab("Awake") +
